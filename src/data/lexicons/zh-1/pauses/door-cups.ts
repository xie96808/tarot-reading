...
export const DOOR_CUPS_OFFERS: readonly PauseOffer[] = [
  ...
  pause1(
    'cups_03',
    'reversed',
    '门缝里三只杯放低了，圆圈缺了一角，有一个人站在举杯之外。你要先怎么待这个空出来的位置？',
    steps(
      action('side', 'engage', '先站进空出来的那一角', '我先站进圆圈空出来的那一角。'),
      action('down', 'engage', '先让杯子保持放低', '我先让自己的杯子和他们一样放低。'),
      '我先把门带上，放低的三只杯留在门外。',
    ),
  ),
  pause2(
    'cups_03',
    'reversed',
    '门缝里那三只杯仍放得很低，缺掉的一角还空着。你要怎么对待这个没举起来的圆圈？',
    steps(
      action('fill', 'engage', '先把空角补上', '我先走到空着的那一角，杯子先不举高。'),
      action('quiet', 'engage', '先离开热闹的圆心', '我先从圆心退到果子那边，杯子放在身侧。'),
      '我先把门带上，没举起来的杯子留在门外。',
    ),
  ),
  pause1(
  ...
  pause1(
    'cups_06',
    'reversed',
    '门缝里花杯被收了回来，没有递到小手里，通向旧房子的路也没人走。你要先怎么待这只被收回的花杯？',
    steps(
      action('hold', 'engage', '先把花杯留在自己手里', '我先把这只被收回的花杯留在自己手里。'),
      action('path', 'engage', '先看那条没人走的路', '我先看通向旧房子、还没人走的那条路。'),
      '我先把门带上，被收回的花杯留在门外。',
    ),
  ),
  pause2(
    'cups_06',
    'reversed',
    '门缝里那只花杯仍被收着，园子的路还空着。你要怎么对待这只没递出去的花杯？',
    steps(
      action('open', 'engage', '先把收着的手松开一点', '我先把收着花杯的手松开一点。'),
      action('step', 'engage', '先在空路上迈一步', '我先在没人走的园路上迈一步，花杯仍收着。'),
      '我先把门带上，没递出去的花杯留在门外。',
    ),
  ),
  pause1(
