...
export const DOOR_SWORDS_OFFERS: readonly PauseOffer[] = [
  ...
  pause1(
    'swords_04',
    'upright',
    '门缝里，一个人躺在石棺上，三柄剑挂在石墙上，第四柄放在腿边，窗是黄蓝菱格。你要先怎么待这四柄剑？',
    steps(
      action('wall', 'engage', '先看石墙上的三柄剑', '我先看挂在石墙上的三柄剑。'),
      action('tomb', 'engage', '先看腿边那一柄', '我先看放在石棺上、腿边的那一柄剑。'),
      '我先把门带上，石墙上和腿边的剑留在门外。',
    ),
  ),
  pause2(
    'swords_04',
    'upright',
    '门缝里那个人仍躺在石棺上，三柄剑还挂在石墙上，第四柄仍在腿边。你要怎么安放这柄放在腿边的剑？',
    steps(
      action('side', 'engage', '先看腿边那一柄剑', '我先看还放在腿边的那一柄剑。'),
      action('pane', 'engage', '先看黄蓝菱格的窗', '我先看那扇黄蓝菱格的窗。'),
      '我先把门带上，还挂在石墙上的剑留在门外。',
    ),
  ),
  pause1(
    'swords_04',
    'reversed',
    '门缝里，躺着的人转过身，三柄剑还挂在石墙上，第四柄仍在腿边的石棺上。你要先怎么待这些还在原处的剑？',
    steps(
      action('sit', 'engage', '先让人坐起一点', '我先让转过身的人坐起一点。'),
      action('hang', 'engage', '先让石墙上的剑继续挂着', '我先让石墙上的三柄剑继续挂着。'),
      '我先把门带上，还在石墙上和腿边的剑留在门外。',
    ),
  ),
  pause2(
    'swords_04',
    'reversed',
    '门缝里人还没有重新躺平，石墙上的三柄剑仍挂着，腿边那柄也还在。你要怎么对待这柄还放在腿边的剑？',
    steps(
      action('flat', 'engage', '先把腿边的剑摆正', '我先把放在腿边的那柄剑摆正。'),
      action('pane', 'engage', '先看窗上的菱格', '我先看窗上黄蓝相间的菱格。'),
      '我先把门带上，还放在腿边的剑留在门外。',
    ),
  ),
  pause1(
  ...
  pause1(
    'swords_07',
    'upright',
    '门缝里，一个人侧着脸，低头看怀里的五柄剑，条纹营帐边还立着两柄。你要先怎么待他怀里的这些剑？',
    steps(
      action('arms', 'engage', '先看他低看的五柄剑', '我先看他低头看着的五柄剑。'),
      action('camp', 'engage', '先看营帐边立着的两柄', '我先看条纹营帐边立着的两柄剑。'),
      '我先把门带上，怀里的和立着的剑留在门外。',
    ),
  ),
  pause2(
    'swords_07',
    'upright',
    '门缝里那个人仍侧着脸，目光还低在怀里的剑上，营帐边的两柄也还立着。你要怎么安放这些还在怀里的剑？',
    steps(
      action('down', 'engage', '先顺着他低下的目光', '我先顺着他低下的目光看怀里的剑。'),
      action('two', 'engage', '先让营帐边的两柄留着', '我先让条纹营帐边的两柄剑留在原地。'),
      '我先把门带上，还在怀里的剑留在门外。',
    ),
  ),
  pause1(
    'swords_07',
    'reversed',
    '门缝里，侧脸的人把脸再转开一点，五柄剑仍在怀里，条纹营帐边的两柄还立着。你要先怎么待这些还在怀里的剑？',
    steps(
      action('show', 'engage', '先看怀里的五柄剑', '我先看还抱在怀里的五柄剑。'),
      action('tent', 'engage', '先看条纹营帐', '我先看那些条纹营帐，剑仍立在旁边。'),
      '我先把门带上，还在怀里的剑留在门外。',
    ),
  ),
  pause2(
    'swords_07',
    'reversed',
    '门缝里五柄剑还在怀里，营帐边的两柄没有被拔起。你要怎么对待这些还被抱着的剑？',
    steps(
      action('set', 'engage', '先把怀里的一柄放低', '我先把怀里的一柄剑放低一点。'),
      action('gaze', 'engage', '先看他低着的侧脸', '我先看他低向剑的那张侧脸。'),
      '我先把门带上，还被抱着的剑留在门外。',
    ),
  ),
  pause1(
  ...
  pause1(
    'swords_09',
    'upright',
    '门缝里，一个人从床上坐起，双手捂着脸，九柄剑在暗处弯成向下的弧，床头是木头。你要先怎么待这九柄弯成弧的剑？',
    steps(
      action('face', 'engage', '先看捂着脸的双手', '我先看捂在脸上的那双手。'),
      action('arc', 'engage', '先看弯下去的那道弧', '我先看暗处弯下去的那九柄剑。'),
      '我先把门带上，弯成弧的九柄剑留在门外。',
    ),
  ),
  pause2(
    'swords_09',
    'upright',
    '门缝里人还坐在床上，双手仍捂着脸，九柄剑还是那道向下的弧。你要怎么安放这些还悬成弧的剑？',
    steps(
      action('rose', 'engage', '先看被子上的玫瑰', '我先看被子上的那些玫瑰。'),
      action('low', 'engage', '先看弧上最低的一柄', '我先看这道弧上最低的那一柄剑。'),
      '我先把门带上，还悬成弧的剑留在门外。',
    ),
  ),
  pause1(
    'swords_09',
    'reversed',
    '门缝里，坐着的人转了过去，九柄剑的弧也跟着转，被子上的玫瑰还在。你要先怎么待这道转过去的剑弧？',
    steps(
      action('turn', 'engage', '先看转过去的那道弧', '我先看转过去的那九柄剑。'),
      action('rose', 'engage', '先看被子上的玫瑰', '我先看被子上还在的玫瑰。'),
      '我先把门带上，转过去的剑弧留在门外。',
    ),
  ),
  pause2(
    'swords_09',
    'reversed',
    '门缝里木头床头还在，人仍转着，九柄剑没有离开那道弧。你要怎么对待这些还挂成弧的剑？',
    steps(
      action('board', 'engage', '先看木头床头', '我先看床头那块木头。'),
      action('edge', 'engage', '先碰弧边上的一柄剑', '我先碰这道弧边上的那一柄剑。'),
      '我先把门带上，还挂成弧的剑留在门外。',
    ),
  ),
  pause1(
    'swords_10',
    'upright',
    '门缝里，一个裹着红披风的人脸朝下躺着，十柄剑在他身后竖成一排，天边有一道黄光。你要先怎么待身后这排竖着的剑？',
    steps(
      action('row', 'engage', '先看身后竖着的剑', '我先看竖在他身后的十柄剑。'),
      action('light', 'engage', '先看天边那道黄光', '我先看天边的那道黄光。'),
      '我先把门带上，竖在身后的剑留在门外。',
    ),
  ),
  pause2(
    'swords_10',
    'upright',
    '门缝里十柄剑仍竖在红披风后面，天边的黄光也还在。你要怎么安放这些还竖着的剑？',
    steps(
      action('cloak', 'engage', '先看裹着的红披风', '我先看裹在身上的红披风。'),
      action('dawn', 'engage', '先让目光停在那道黄光上', '我先让目光停在天边的那道黄光上。'),
      '我先把门带上，还竖成一排的剑留在门外。',
    ),
  ),
  pause1(
    'swords_10',
    'reversed',
    '门缝里，裹着红披风的人转过一点，十柄剑仍在身后竖成一排，天边的黄光还在。你要先怎么待这些还竖着的剑？',
    steps(
      action('edge', 'engage', '先只看最边上的一柄', '我先只看这排剑最边上的一柄。'),
      action('dawn', 'engage', '先看还在的那道黄光', '我先看天边还在的那道黄光。'),
      '我先把门带上，还竖在身后的剑留在门外。',
    ),
  ),
  pause2(
    'swords_10',
    'reversed',
    '门缝里那排剑仍竖着，红披风的人还没有完全转过来。你要怎么对待这些还排在身后的剑？',
    steps(
      action('apart', 'engage', '先让最靠边的一柄离排远一点', '我先让最靠边的一柄剑离这排远一点。'),
  ...
  pause1(
    'swords_queen',
    'upright',
    '门缝里，云边的座位上，一个人把剑竖直，另一只手举起，天上有一只鸟。你要先怎么待这柄竖着的剑？',
    steps(
  ...
  pause2(
    'swords_queen',
    'upright',
    '门缝里那柄剑仍竖着，举起的手也还在，扶手上有一个雕着的小头，天上的鸟还在飞。你要怎么安放这柄还竖着的剑？',
    steps(
      action('head', 'engage', '先看扶手上的小头', '我先看座位扶手上雕着的那个小头。'),
      action('bird', 'engage', '先看天上的那只鸟', '我先看还在飞的那只鸟。'),
      '我先把门带上，还竖着的剑留在门外。',
    ),
  ),
  pause1(
    'swords_queen',
    'reversed',
    '门缝里，剑仍竖得笔直，座位上的人把脸转开，举起的手没有放下。你要先怎么待这柄仍笔直的剑？',
    steps(
  ...
  pause2(
    'swords_queen',
    'reversed',
    '门缝里剑还是那么直，人仍把脸转开，天上的鸟还在。你要怎么对待这柄没有偏过的剑？',
    steps(
      action('hand', 'engage', '先让举起的手停一下', '我先让举起的那只手停一下。'),
      action('bird', 'engage', '先看天上的那只鸟', '我先看还在飞的那只鸟。'),
      '我先把门带上，没有偏过的剑留在门外。',
    ),
  ),
