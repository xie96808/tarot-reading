...
export const HAND_WANDS_OFFERS: readonly PauseOffer[] = [
  ...
  pause1(
    'wands_09',
    'upright',
    '掌心里，一个人头上有一条白布，手里把一根权杖竖着握住，身后八根杖立成一排。你要先怎么待身后这排杖？',
    steps(
      action('row', 'engage', '先看身后的八根杖', '我先看身后立成一排的八根权杖。'),
      action('band', 'engage', '先看头上的白布', '我先看头上那条白布。'),
      '我把竖着握住的杖和这排杖放回桌上。',
    ),
  ),
  pause2(
    'wands_09',
    'upright',
    '掌心里那根权杖仍被竖着握住，头上的白布也还在。你要怎么安放他竖着握住的这根杖？',
    steps(
      action('held', 'engage', '先看他竖着握住的那根', '我先看他竖着握住的那根权杖。'),
  ...
  pause1(
    'wands_09',
    'reversed',
    '掌心里这张牌倒着，竖着握住的权杖、头上的白布和身后立着的八根杖仍印着。你要先把身后的杖转到哪一边？',
    steps(
      action('row', 'engage', '先把身后的杖转上来', '我先把身后立着的八根权杖转上来。'),
      action('band', 'engage', '先看头上的白布', '我先看印在头上的白布。'),
      '我把倒着的九根权杖放回桌上。',
    ),
  ),
  pause2(
    'wands_09',
    'reversed',
    '牌仍倒在掌心，白布还在头上，一根杖还被竖着握住。你要怎么放这条还印着的白布？',
    steps(
      action('band', 'engage', '先按住这条白布', '我先按住头上这条白布。'),
      action('held', 'engage', '先看竖着握住的杖', '我先看他还竖着握住的那根权杖。'),
      '我把倒着的白布和权杖放回桌上。',
    ),
  ),
  pause1(
