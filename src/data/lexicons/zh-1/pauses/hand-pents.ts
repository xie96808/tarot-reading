...
export const HAND_PENTS_OFFERS: readonly PauseOffer[] = [
  ...
  pause1(
    'pents_03',
    'upright',
    '掌心里，石拱砌到一半，拱上嵌着星币，图纸摊在石上，凿子靠在拱边。你要先怎么待这截没砌完的石拱？',
    steps(
      action('arch', 'engage', '先看砌到一半的石拱', '我先看这截砌到一半的石拱。'),
      action('plan', 'engage', '先看摊开的图纸', '我先看摊在石上的图纸。'),
      '我把石拱、图纸和凿子放回桌上。',
    ),
  ),
  pause2(
    'pents_03',
    'upright',
    '掌心里石拱仍停在一半，图纸和凿子都还在。你要怎么安放靠在拱边的这把凿子？',
    steps(
      action('chisel', 'engage', '先看靠着的凿子', '我先看靠在拱边的凿子。'),
      action('coins', 'engage', '先看拱上的星币', '我先看嵌在石拱上的星币。'),
      '我把没砌完的石拱放回桌上。',
    ),
  ),
  pause1(
    'pents_03',
    'reversed',
    '掌心里这张牌倒着，石拱、星币、图纸和凿子仍印着。你要先把图纸转到哪一边？',
    steps(
      action('plan', 'engage', '先把图纸转上来', '我先把摊开的图纸转上来。'),
      action('chisel', 'engage', '先看倒着的凿子', '我先看印在拱边的凿子。'),
      '我把倒着的石拱放回桌上。',
    ),
  ),
  pause2(
    'pents_03',
    'reversed',
    '牌仍倒在掌心，凿子还靠在石拱边上。你要怎么放这把还印着的凿子？',
    steps(
      action('chisel', 'engage', '先按住这把凿子', '我先按住靠在拱边的凿子。'),
      action('stone', 'engage', '先看最上面的那块石', '我先看石拱上最靠外的那块石。'),
      '我把倒着的图纸和石拱放回桌上。',
    ),
  ),
  pause1(
  ...
  pause1(
    'pents_07',
    'upright',
    '掌心里，一个人拄着锄，面前的枝上挂着七枚星币。你要先怎么待枝上这些星币？',
    steps(
      action('branch', 'engage', '先看枝上的七枚', '我先看挂在枝上的七枚星币。'),
  ...
  pause2(
    'pents_07',
    'upright',
    '掌心里七枚星币仍挂在枝上，锄也还拄着。你要怎么安放这把还拄着的锄？',
    steps(
      action('hoe', 'engage', '让锄仍拄在身侧', '我让这把锄仍拄在身侧。'),
      action('low', 'engage', '先看枝上最下面的一枚', '我先看枝上最下面的那一枚星币。'),
      '我把挂在枝上的星币放回桌上。',
    ),
  ),
  pause1(
    'pents_07',
    'reversed',
    '掌心里这张牌倒着，锄、枝和七枚星币仍印着。你要先把枝上的星币转到哪一边？',
    steps(
      action('coins', 'engage', '先把枝上的星币转上来', '我先把枝上的七枚星币转上来。'),
      action('hoe', 'engage', '先看倒着的锄', '我先看印在身侧的那把锄。'),
      '我把倒着的七枚星币放回桌上。',
    ),
  ),
  pause2(
    'pents_07',
    'reversed',
    '牌仍倒在掌心，人还靠在锄上，星币还挂在枝上。你要怎么放这把还印着的锄？',
    steps(
      action('hoe', 'engage', '先按住这把锄', '我先按住他靠着的这把锄。'),
      action('branch', 'engage', '先看挂着星币的枝', '我先看还挂着星币的那根枝。'),
      '我把倒着的锄和星币放回桌上。',
    ),
  ),
  pause1(
    'pents_08',
    'upright',
    '掌心里有一张工作台，锤子对着台上的一枚星币，墙上已经挂着几枚。你要先怎么待台上这一枚？',
    steps(
      action('coin', 'engage', '先看台上这一枚', '我先看工作台上这一枚星币。'),
      action('hammer', 'engage', '先看台上的锤子', '我先看对着星币的那把锤子。'),
      '我把工作台和星币放回桌上。',
    ),
  ),
  pause2(
    'pents_08',
    'upright',
    '掌心里锤子仍对着台上那枚星币，墙上的也还挂着。你要怎么安放墙上这些已经挂着的星币？',
    steps(
      action('wall', 'engage', '先看墙上挂着的', '我先看已经挂在墙上的星币。'),
      action('bench', 'engage', '先看工作台的边', '我先看这张工作台的边。'),
      '我把锤子和台上的星币放回桌上。',
    ),
  ),
  pause1(
    'pents_08',
    'reversed',
    '掌心里这张牌倒着，锤子、工作台、台上的星币和墙上的星币仍印着。你要先把锤子转到哪一边？',
    steps(
      action('hammer', 'engage', '先把锤子转上来', '我先把这把锤子转上来。'),
      action('wall', 'engage', '先看倒着的墙', '我先看印着星币的那面墙。'),
      '我把倒着的工作台放回桌上。',
    ),
  ),
  pause2(
    'pents_08',
    'reversed',
    '牌仍倒在掌心，台上那枚星币还在锤子下面。你要怎么放这枚还印在台上的星币？',
    steps(
      action('coin', 'engage', '先托住台上这一枚', '我先托住工作台上这一枚星币。'),
      action('hang', 'engage', '先看墙上挂着的几枚', '我先看还挂在墙上的几枚星币。'),
      '我把倒着的锤子和星币放回桌上。',
    ),
  ),
  pause1(
  ...
  pause1(
    'pents_king',
    'upright',
    '掌心里，座位上的人把一枚星币放在膝上，身后是城堡和藤，座上有牛头。你要先怎么待这枚放在膝上的星币？',
    steps(
  ...
  pause2(
    'pents_king',
    'upright',
    '掌心里星币仍在膝上，城堡、藤和牛头都还在。你身上哪一种手艺够用在这枚膝上的星币上？',
    steps(
      action('craft', 'engage', '用正在学的那门手艺', '我用正在学的那门手艺，先让这枚星币留在膝上。'),
      action('vine', 'engage', '先看爬着的藤', '我先看爬在城堡上的藤。'),
      '我把牛头座位和星币放回桌上。',
    ),
  ),
  pause1(
    'pents_king',
    'reversed',
    '掌心里这张牌倒着，星币、城堡、藤和牛头仍印着。你要先把膝上的星币转到哪一边？',
    steps(
      action('coin', 'engage', '先把星币转上来', '我先把膝上的星币转上来。'),
