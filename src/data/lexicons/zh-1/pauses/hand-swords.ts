...
export const HAND_SWORDS_OFFERS: readonly PauseOffer[] = [
  ...
  pause1(
    'swords_05',
    'upright',
    '掌心里，前面的人把剑握在身前，沙地上竖着三柄剑，另两个人朝水边走开，云是裂开的。你要先怎么待沙地上这三柄竖着的剑？',
    steps(
      action('sand', 'engage', '先看沙地上竖着的三柄', '我先看竖在沙地上的三柄剑。'),
  ...
  pause2(
    'swords_05',
    'upright',
    '掌心里三柄剑仍竖在沙地上，身前的剑还握着，水边的云还裂着。你要怎么安放水边这些裂开的云？',
    steps(
      action('cloud', 'engage', '先看裂开的云', '我先看水边那些裂开的云。'),
      action('held', 'engage', '先看身前握着的剑', '我先看还握在身前的剑。'),
      '我把竖在沙地上的三柄剑放回桌上。',
    ),
  ),
  pause1(
    'swords_05',
    'reversed',
    '掌心里这张牌倒着，沙地上竖着的三柄剑、身前的剑和朝水边走开的人仍印着。你要先把沙地上的剑转到哪一边？',
    steps(
      action('sand', 'engage', '先把沙地上的剑转上来', '我先把竖在沙地上的三柄剑转上来。'),
  ...
  pause2(
    'swords_05',
    'reversed',
    '牌仍倒在掌心，两个人还朝水边走开，三柄剑还竖在沙地上，云还是裂开的。你要怎么放这片还印着的水？',
    steps(
