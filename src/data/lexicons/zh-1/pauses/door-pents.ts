...
export const DOOR_PENTS_OFFERS: readonly PauseOffer[] = [
  ...
  pause1(
    'pents_04',
    'upright',
    '门缝里，一个人坐着，一枚星币抱在胸口，一枚顶在头上，两枚压在脚下，城在身后。你要先怎么待这四枚分在胸口、头顶和脚下的星币？',
    steps(
      action('chest', 'engage', '先看胸口那一枚', '我先看被抱在胸口的那一枚星币。'),
      action('city', 'engage', '先看身后的城', '我先看星币后面的那座城。'),
      '我先把门带上，分在胸口、头顶和脚下的四枚星币留在门外。',
    ),
  ),
  pause2(
    'pents_04',
  ...
  pause1(
    'pents_05',
    'reversed',
    '门缝里雪还在下，两个人仍站在窗下，五枚星币嵌在有光的玻璃上。你要先怎么待这扇窗和雪里的人？',
    steps(
      action('glass', 'engage', '先看窗上的五枚星币', '我先看嵌在窗玻璃上的那五枚星币。'),
      action('snow', 'engage', '先和雪里的人站在一起', '我先站在雪里，和窗下的两个人在一起。'),
      '我先把门带上，雪里的两个人留在门外。',
    ),
  ),
  pause2(
    'pents_05',
    'reversed',
    '门缝里那两个人还在雪里，五枚星币仍嵌在有光的窗上。你要怎么对待窗上这五枚星币？',
    steps(
      action('pane', 'engage', '先只看窗玻璃上的星币', '我先只看窗玻璃上的五枚星币。'),
      action('stay', 'engage', '先让脚留在雪里', '我先让脚留在窗下的雪里。'),
      '我先把门带上，有光的窗子留在门外。',
    ),
  ),
  pause1(
  ...
  pause1(
    'pents_06',
    'reversed',
    '门缝里，秤在一只手里，星币在另一只递出的手里，也到了跪着的人手边。你要先怎么待这些正被递出的星币？',
    steps(
      action('hold', 'engage', '先让星币留在递出的手里', '我先让这些星币留在递出的那只手里。'),
      action('kneel', 'engage', '先看跪着的那双手', '我先看跪着的人手边的星币，秤仍在另一只手里。'),
      '我先把门带上，正被递出的星币留在门外。',
    ),
  ),
  pause2(
    'pents_06',
    'reversed',
    '门缝里秤仍在一只手里，星币还在递出的手和跪着的人手边。你要怎么对待这些正被递着的星币？',
    steps(
      action('one', 'engage', '先只从递出的手里送出一枚', '我先只从递出的手里送出一枚星币。'),
      action('hands', 'engage', '先看跪着的人手边', '我先看跪着的人手边那几枚星币。'),
      '我先把门带上，还在递出的手里的星币留在门外。',
    ),
  ),
  pause1(
    'pents_07',
  ...
  pause1(
    'pents_07',
    'reversed',
    '门缝里，人仍靠在锄上，目光停在枝头的七枚星币上。你要先怎么待这把锄和这些还在枝上的星币？',
    steps(
      action('hoe', 'engage', '先让锄继续撑着', '我先让这把锄继续撑着身子。'),
      action('gaze', 'engage', '先顺着目光看枝上的星币', '我先顺着这道目光看枝上的星币。'),
      '我先把门带上，锄和枝上的星币留在门外。',
    ),
  ),
  pause2(
    'pents_07',
    'reversed',
    '门缝里那个人还靠着锄，七枚星币仍挂在枝上。你要怎么对待枝上这些还挂着的星币？',
    steps(
      action('look', 'engage', '先把目光留在枝上', '我先把目光留在枝上的星币。'),
      action('prop', 'engage', '先让锄仍撑在身侧', '我先让锄仍撑在身侧。'),
      '我先把门带上，靠着的锄留在门外。',
    ),
  ),
  pause1(
  ...
  pause1(
    'pents_09',
    'reversed',
    '门缝里，鸟仍停在手套上，葡萄和九枚星币都还在藤上。你要先怎么待这只停着的鸟？',
    steps(
      action('bird', 'engage', '先看手套上的鸟', '我先看停在手套上的这只鸟。'),
      action('vine', 'engage', '先看藤上的葡萄', '我先看藤上还结着的葡萄。'),
      '我先把门带上，手套上的鸟留在门外。',
    ),
  ),
  pause2(
    'pents_09',
    'reversed',
    '门缝里那只鸟仍在手套上，葡萄和星币也都还在藤上。你要怎么对待藤上这些星币？',
    steps(
      action('coin', 'engage', '先只看藤上的一枚星币', '我先只看葡萄藤上的一枚星币。'),
      action('stay', 'engage', '先让鸟继续停着', '我先让这只鸟继续停在手套上。'),
      '我先把门带上，藤上的星币留在门外。',
    ),
  ),
  pause1(
  ...
  pause1(
    'pents_queen',
    'reversed',
    '门缝里，星币仍放在膝上，兔子就在座位旁边。你要先怎么待这枚还在膝上的星币？',
    steps(
      action('coin', 'engage', '先看膝上的星币', '我先看这枚还放在膝上的星币。'),
      action('rabbit', 'engage', '先看座位旁的兔子', '我先看已经在座位旁边的那只兔子。'),
      '我先把门带上，膝上的星币留在门外。',
    ),
  ),
  pause2(
    'pents_queen',
    'reversed',
    '门缝里膝上的星币还在，兔子也还在座位旁。你要怎么对待这只已经在旁边的兔子？',
    steps(
      action('near', 'engage', '先让兔子留在座位旁', '我先让这只兔子留在座位旁边。'),
      action('lap', 'engage', '先再看一眼膝上的星币', '我先再看一眼膝上的星币，兔子仍在旁边。'),
      '我先把门带上，座位旁的兔子留在门外。',
    ),
  ),
  pause1(
  ...
  pause1(
    'pents_king',
    'reversed',
    '门缝里，星币仍在膝上，藤蔓缠着带牛头的座位，城堡在远处。你要先怎么待这枚还在膝上的星币？',
    steps(
      action('knee', 'engage', '先看膝上的星币', '我先看这枚还在膝上的星币。'),
      action('vine', 'engage', '先看缠在座位上的藤', '我先看缠在座位上的藤蔓。'),
      '我先把门带上，膝上的星币留在门外。',
    ),
  ),
  pause2(
    'pents_king',
    'reversed',
    '门缝里那枚星币还在膝上，藤还在座位上，城堡仍远在后面。你要怎么对待膝上这枚星币？',
    steps(
      action('keep', 'engage', '先让星币留在膝上', '我先让这枚星币留在膝上。'),
      action('far', 'engage', '先看远处的城堡', '我先看远处的那座城堡。'),
      '我先把门带上，膝上的星币和藤留在门外。',
    ),
  ),
];
